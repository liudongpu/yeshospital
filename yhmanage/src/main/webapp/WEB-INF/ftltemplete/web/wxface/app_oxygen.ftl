	...
	<#list a_memberlist as em>
		<div id="yeswx_tab_item_t_${em_index+1}" <#if em_index!=0>class="wxcss_base_none" </#if> > 
		   <div class="weui_cells weui_cells_access">
		  		<a class="weui_cell" href="grid_list?u_data_type=oxygen&u_member_code=${em["member_code"]}">
		   ...
		   <br/>
			...
			<@m_wx_html_initjs e_js="yeswx.report_show('com_srnpr_yeshospital_api_wx_ReportOxygen','"+em["member_code"]+"')" />
	</#list>
