...
${b_method.upClass("com.srnpr.yeshospital.support.AppPageSupport").upFlagOpen()}
	...
	<div class="zmcss_h_20"></div>
 	...
 	<input id="yesapp_ts_search" type="search" placeholder="请输入老人姓名"  <@m_mobile_event_input "yesapp_tour.tour_select_search(this)"/> />
	</div>
	...
	<div id="yesapp_ts_count" class="yb_message_desc"></div>
	<div class="zmcss_h_10"></div>
