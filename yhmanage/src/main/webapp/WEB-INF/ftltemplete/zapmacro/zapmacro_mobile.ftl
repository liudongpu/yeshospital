...
<#-- 查看页 -->
<#macro m_zapmacro_mobile_page_book e_page>
<form class="form-horizontal" method="POST" >

	
	<#list e_page.upBookData()  as e>
		
	  	<@m_zapmacro_mobile_book_field e e_page/>
...
<#-- 异步加载列表页 -->
<#macro m_zapmacro_mobile_ajax_chart e_page>

	<div class="zw_page_common_ajax_inquire">
		<@m_zapmacro_mobile_page_inquire e_page />
	</div>
...
<#-- 列表页 -->
<#macro m_zapmacro_mobile_page_chart e_page>
	...
	<@m_zapmacro_mobile_table e_pagedata />
	<@m_zapmacro_mobile_page_pagination e_page  e_pagedata />
	
	</div>
</#macro>

<#-- 查询区域 -->
<#macro m_zapmacro_mobile_page_inquire e_page>
	<form class="form-horizontal" method="POST" >
		<@m_zapmacro_mobile_auto_inquire e_page />
		<@m_zapmacro_mobile_auto_operate   e_page.getWebPage().getPageOperate() "116001009" />
	</form>
</#macro>
...
<#--查询的自动输出判断 -->
<#macro m_zapmacro_mobile_auto_inquire e_page>
	<#list e_page.upInquireData() as e>
	
		<#if e.getQueryTypeAid()=="104009002">
			<@m_zapmacro_mobile_field_between e  e_page/>
		<#elseif e.getQueryTypeAid()=="104009020">
			<@m_zapmacro_mobile_field_betweensfm e  e_page/>
		<#elseif e.getQueryTypeAid()=="104009001">
			<#-- url专用  不显示 -->

	  	<#elseif  e.getFieldTypeAid()=="104005019">
	  		<@m_zapmacro_mobile_field_select  e  e_page "请选择"/>
	  	<#else>
	  		<@m_zapmacro_mobile_auto_field e e_page/>
...
<#-- 页面字段的自动输出判断 -->
<#macro m_zapmacro_mobile_auto_list e_pagedata   e_page>
...
<#-- 页面字段的自动输出判断 -->
<#macro m_zapmacro_mobile_auto_field e_field   e_page>
	
		<#if e_field.getFieldTypeAid()=="104005008">
	  		<@m_zapmacro_mobile_field_hidden e_field/>
	  	<#elseif  e_field.getFieldTypeAid()=="104005001">
	  		  <#-- 内部处理  不输出 -->
	  	<#elseif  e_field.getFieldTypeAid()=="104005003">
	  		<@m_zapmacro_mobile_field_component  e_field  e_page/>
	  	<#elseif  e_field.getFieldTypeAid()=="104005004">
	  		<@m_zapmacro_mobile_field_date  e_field />
		<#elseif  e_field.getFieldTypeAid()=="104005022">
	  	...
	  	<#elseif  e_field.getFieldTypeAid()=="104005020">
	  		<@m_zapmacro_mobile_field_textarea  e_field />
	  	<#elseif  e_field.getFieldTypeAid()=="104005005">
	  		<@m_zapmacro_mobile_field_editor  e_field  e_page />
	  	<#elseif  e_field.getFieldTypeAid()=="104005021">
	  		<@m_zapmacro_mobile_field_upload  e_field  e_page />
	  	<#elseif  e_field.getFieldTypeAid()=="104005009">
	  		<@m_zapmacro_mobile_field_text  e_field />
	  	<#else>
	  		<@m_zapmacro_mobile_field_span e_field/>
	  	</#if>
</#macro>
...
<#-- 显示页的自动输出判断 -->
<#macro m_zapmacro_mobile_book_field e_field   e_page>
...
<#-- 字段：显示专用 -->
<#macro m_zapmacro_mobile_field_show e_field e_page>
	<@m_zapmacro_mobile_field_start text=e_field.getFieldNote()+":" />
...
<#-- 字段：纯展示 -->
<#macro m_zapmacro_mobile_field_span e_field>
	<@m_zapmacro_mobile_field_start text=e_field.getFieldNote() for=e_field.getPageFieldName() />
		${e_field.getPageFieldValue()?default("")}
	<@m_zapmacro_mobile_field_end />
</#macro>
...
<#-- 字段：日期 -->
<#macro m_zapmacro_mobile_field_date e_field>
	<@m_zapmacro_mobile_field_start text=e_field.getFieldNote() for=e_field.getPageFieldName() />
...
<#-- 字段：长文本框 -->
<#macro m_zapmacro_mobile_field_textarea e_field>
	<@m_zapmacro_mobile_field_start text=e_field.getFieldNote() for=e_field.getPageFieldName() />
...
<#macro back_m_zapmacro_mobile_field_upload e_field e_page>
	...
	<@m_zapmacro_mobile_html_script "zapjs.f.ready(function(){zapjs.f.require(['zapweb/js/zapweb_upload'],function(a){a.upload_file('"+e_field.getPageFieldName()+"','"+e_page.upConfig("zapweb.upload_target")+"');}); });" />
...
<#-- 字段：编辑框 -->
<#macro m_zapmacro_mobile_field_editor e_field  e_page>
	<@m_zapmacro_mobile_field_start text=e_field.getFieldNote() for=e_field.getPageFieldName() />
		<textarea class="w_none " id="${e_field.getPageFieldName()}"  name="${e_field.getPageFieldName()}">${e_field.getPageFieldValue()}</textarea>
	<@m_zapmacro_mobile_field_end />
	  
	<@m_zapmacro_mobile_html_script "zapjs.f.ready(function(){zapjs.zw.editor_show('"+e_field.getPageFieldName()+"','"+e_page.upConfig("zapweb.upload_target")+"')});" />
...
<#macro m_zapmacro_mobile_field_select   e_field    e_page    e_text_select="">
	<@m_zapmacro_mobile_field_start text=e_field.getFieldNote() for=e_field.getPageFieldName() />
...
<#macro m_zapmacro_mobile_field_checkbox   e_field    e_page    >
	<@m_zapmacro_mobile_field_start text=e_field.getFieldNote() for=e_field.getPageFieldName() />
...
<#-- 字段：文本范围 -->
<#macro m_zapmacro_mobile_field_between e_field  e_page >

	<@m_zapmacro_mobile_field_start text=e_field.getFieldNote() for=e_page.upConst("126022001",e_field.getPageFieldName(),"between_from") />
...
<#-- 字段：文本范围时分秒 -->
<#macro m_zapmacro_mobile_field_betweensfm e_field  e_page >
	<@m_zapmacro_mobile_field_start text=e_field.getFieldNote() for=e_page.upConst("126022001",e_field.getPageFieldName(),"between_from") />
	    		从
...
<#-- 页面按钮的自动输出 -->
<#macro m_zapmacro_mobile_auto_operate     e_list_operates  e_area_type>
	<div class="control-group">
    	<div class="controls">
    		<@m_zapmacro_mobile_show_operate e_list_operates  e_area_type "btn  btn-success" />
    	</div>
	</div>
</#macro>

<#-- 按钮显示 -->
<#macro m_zapmacro_mobile_show_operate     e_list_operates  e_area_type  e_style_css >

			<#list e_list_operates as e>
    			<#if e.getAreaTypeAid()==e_area_type>
    		
	    			<#if e.getOperateTypeAid()=="116015010">
	    				<@m_zapmacro_mobile_operate_button e  e_style_css/>
	    			<#else>
	    				<@m_zapmacro_mobile_operate_link e  e_style_css/>
	    			</#if>
...
<#-- 工具栏按钮 -->
<#macro m_zapmacro_mobile_set_operate     e_list_operates  e_area_type  e_style_css >
			<#list e_list_operates as e>
    			<#if e.getAreaTypeAid()==e_area_type>
...
<#-- 页面按钮 -->
<#macro m_zapmacro_mobile_operate_button  e_operate  e_style_css>
...
<#-- 页面按钮 -->
<#macro m_zapmacro_mobile_operate_link  e_operate  e_style_css>
...
<#-- 转换map输出 -->
<#macro m_zapmacro_mobile_format_map_hidden  e_map e_key_left="">
...
<#macro m_zapmacro_mobile_html_script  e_info >
...
<#-- 按钮显示 -->
<#macro m_zapmacro_mobile_top_operate     e_list_operates  e_area_type   >
