...
public class PostDataInput extends RootInput implements IPostDataInput {
	...
	@ZapcomApi(require = 1, value = "测量时间", remark = "测量的时间", verify = "datetime", demo = "2014-01-01 00:00:00")
	private String postProcessTime = "";

	@ZapcomApi(require = 1, value = "客户端时间", remark = "客户端的当前时间", verify = "datetime", demo = "2014-01-01 00:00:00")
