		...
		for (MDataMap map : DbUp.upTable("yh_post_glucose").queryAll(
			...
			itemSeries.getData()
					.add(new BigDecimal[] { dTime,
							new BigDecimal(map.get("glucose")) });
